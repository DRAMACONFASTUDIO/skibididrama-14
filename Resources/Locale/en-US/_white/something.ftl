...
light-examine = - {CAPITALIZE(POSS-ADJ($ent))} [bold]{$item}[/bold] on {POSS-ADJ($ent)} shoulder
outer-examine = - {CAPITALIZE(POSS-ADJ($ent))} [bold]{$item}[/bold] on {POSS-ADJ($ent)} body.
suitstorage-examine = - {CAPITALIZE(POSS-ADJ($ent))} [bold]{$item}[/bold] on {POSS-ADJ($ent)} sling.
...
id-examine-full = - {CAPITALIZE(POSS-ADJ($wearer))} ID: [bold]{$fullName}{$jobSuffix}[/bold].
id-examine = - {CAPITALIZE(POSS-ADJ($wearer))} ID: [bold]{$jobSuffix}[/bold].
...
suitstorage-examine-selfaware = - Your [bold]{$item}[/bold] on your sling.
light-examine-selfaware = - Your [bold]{$item}[/bold] on your shoulder.
...
id-examine-full-selfaware = - Your ID: [bold]{$fullName}{$jobSuffix}[/bold].
id-examine-selfaware = - Your ID: [bold]{$jobSuffix}[/bold].
